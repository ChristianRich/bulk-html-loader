	...
	_loadItem: function(loaderItem, finalCallback){
		...
		var loadWithRetry = function(loaderItem, retryCallback){
			...
			var options = {
                ...
                // Attaches a random user agent string to the http request header mimicking a user request from a browser (some hosts will reject requests with a user agent string)
				headers: {
